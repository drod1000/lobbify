...
describe Outing do
  describe "validations" do
    context "invalid attributes" do
      ...
      it "is invalid without base cost" do
        outing = Outing.create(title: "thing", image_url: "thingy1", image_url: "bob")
    ...
    context "valid attributes" do
      it "is valid" do
        outing = Outing.create(title: "thing", description: "thingy3", image_url: "thingy2", image_url: "bob", base_cost: 4)
  ...
  describe "relationships" do
    it "belongs to a politician" do
      outing = Outing.create(title: "thing", image_url: "thingy", image_url: "bob")
